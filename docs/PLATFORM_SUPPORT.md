...
| 原生 macOS 桌面安装包 | arm64（CI） | 构建中/未公证 | tag CI 生成 DMG；当前仓库不承诺本机签名、公证或 Intel 产物，下载前核对 Release 说明。 |
| 原生 Linux 桌面安装包 | x86_64（CI） | 构建中 | tag CI 生成 deb/AppImage；目标系统需要 WebKitGTK/桌面运行库，下载前核对 Release 说明。 |
